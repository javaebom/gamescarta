 ...
 */
public class TesteRegrasCelula {
    ...
    /**
     * Metodo que testa movimentacao de carta de celula para outra celula vazia:MOVIMENTACAO VÁLIDA
     */
    @Test
    public void testaEnviarCartaDeCelulaParaOutra(){

        Carta carta2Ouro = new Carta();
        carta2Ouro.setCarta(2, "OURO");
        celula1.getPilha().push(carta2Ouro);

        assertTrue(celula2.verifyRule(2, "OURO", celula1));
